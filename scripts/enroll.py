...
"""Enroll a face: stand in front of the camera, run this ON the vision Pi.
    ...
    ~/sparc_venv/bin/python scripts/enroll.py --name Nicholas

Collects N face embeddings from the live enrichment stream (sparc/vision/rich),
...
from sparc_common.bus import Bus  # noqa: E402
from sparc_common.types import DetectionFrame  # noqa: E402
...
def main() -> None:
    ...
    bus.subscribe("sparc/vision/rich", DetectionFrame, on_rich)
    bus.start()
