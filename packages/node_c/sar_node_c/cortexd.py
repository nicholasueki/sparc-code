...
Run: python -m sar_node_c.cortexd
"""
...
log = logging.getLogger("sar.cortexd")

CFG = config.get("node_c", {})
PERSONA = config.get("personality.persona", "You are SAR, a companion robot.")

app = FastAPI(title="sar-cortexd")
...
def think(req: ThinkRequest) -> ThinkResponse:
    ...
    if not parsed:
        ...
        from sar_common.types import OptionMeta, OptionSet
