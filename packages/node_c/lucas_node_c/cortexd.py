...
Run: python -m lucas_node_c.cortexd
"""
...
log = logging.getLogger("lucas.cortexd")

CFG = config.get("node_c", {})
PERSONA = config.get("personality.persona", "You are Lucas, a companion robot.")

app = FastAPI(title="lucas-cortexd")
...
def think(req: ThinkRequest) -> ThinkResponse:
    ...
    if not parsed:
        ...
        from lucas_common.types import OptionMeta, OptionSet
