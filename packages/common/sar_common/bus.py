...
log = logging.getLogger("sar.bus")
T = TypeVar("T", bound=BaseModel)

TOPICS: dict[str, type[BaseModel]] = {
    "sar/vision/tier0": DetectionFrame,
    "sar/vision/rich": DetectionFrame,
    "sar/audio/speech": SpeechEvent,
    "sar/audio/sound": SoundEvent,
    "sar/audio/transcript": Transcript,
    "sar/tts/say": SpeakRequest,
}
