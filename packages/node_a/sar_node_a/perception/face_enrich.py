...
from sar_common.types import Detection, DetectionFrame

log = logging.getLogger("sar.face")
...
class BoxMirror:
    ...
    def __init__(self, bus: Bus):
        ...
        bus.subscribe("sar/vision/tier0", DetectionFrame, self._on_frame)
...
def main() -> None:
    ...
    while True:
        ...
        try:
            ...
            if dets:
                bus.publish("sar/vision/rich", DetectionFrame(
